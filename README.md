...
Learning how to participate in the open source projects by making a pull request in GitHub.com
...
To finish this assignment, you have to install install/setup `Java 8`, [`maven`](https://maven.apache.org/install.html) and [`git`](https://git-scm.com/book/en/v2/Getting-Started-Installing-Git)
...
It usually takes several days to review your changes, so you should make your PR early.
